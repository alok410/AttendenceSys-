  ...
  return (
    <>
      ...
      <div style={{ display: "flex", gap: "50px", padding: "20px" }}>
                    ...
                    <tr key={stu.id}>
                      ...
                      <td>
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                          <a style={{ cursor: "pointer", marginRight: "25px" }} onClick={() => handleEditClick(stu)}>
                            <img style={{ height: "25px" }} src={EditIcon} alt="Edit" />
                          </a>
                          <a style={{ cursor: "pointer" }} onClick={() => handleDelete(stu.id)}>
        ...
        {/* Add/Edit Form */}
        <div style={{ padding: "15px", border: "1px solid #ccc", borderRadius: "10px", width: "350px", alignSelf: "flex-start" }}>
